<template>
  <v-card class="rounded-lg overflow-hidden relative" outlined style="border-width: 2px;">
    <img src="/images/ui/link.png" class="flex-shrink-0 absolute" height="90" style="bottom: 0; left: 0;">
    <v-card-text class="pa-0 relative" style="height: 300px;">
      <div class="d-flex flex-column justify-space-between pt-2 pl-2 pb-2 h-100">
        <div class="">
          ...
          <div class="overflow-hidden mt-1 mb-0 mx-2" style="height: 200px;">
            <p class="grey--text text--darken-2 caption">
              {{ item.description }}
            </p>
          </div>
        </div>
        <div class="mx-3 d-flex justify-end alien-center">
          <div class="">
