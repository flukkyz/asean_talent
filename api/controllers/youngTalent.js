...
module.exports = {
  ...
  count: async (req, res, next) => {
    try {
      const data = await Talent.count({ where: { talent_group: 'young_talent' } })
  ...
  countByIndustry: async (req, res, next) => {
    const sql = `select 
                  ...
                  where talent_group = 'young_talent'
  ...
  index: async (req, res, next) => {
    ...
    let where = { talent_group: 'young_talent' }
  ...
  store: async (req, res, next) => {
    ...
    try {
      const newData = await db.sequelize.transaction(async (t) => {
        ...
        data.talent_group = 'young_talent'
