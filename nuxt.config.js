...
export default {
  ...
  head: {
    ...
    meta: [
      ...
      { name: 'msapplication-TileImage', content: '/images/icons/ms-icon-144x144.png' },
    ...
    link: [
      ...
      { rel: 'icon', type: 'image/png', sizes: '36x36', href: '/images/icons/android-icon-36x36.png' },
      { rel: 'icon', type: 'image/png', sizes: '48x48', href: '/images/icons/android-icon-48x48.png' },
      { rel: 'icon', type: 'image/png', sizes: '192x192', href: '/images/icons/android-icon-192x192.png' },
      { rel: 'icon', type: 'image/png', sizes: '70x70', href: '/images/icons/ms-icon-70x70.png' },
      { rel: 'icon', type: 'image/png', sizes: '150x150', href: '/images/icons/ms-icon-150x150.png' },
      { rel: 'icon', type: 'image/png', sizes: '310x310', href: '/images/icons/ms-icon-310x310.png' },
  ...
  env: {
    appName: process.env.APP_NAME || 'ASEAN TALENT',
