<template>
  <v-container>
    <h3>
      Upload {{ modelName }}
      <a href="/files/example_training_course_template.xlsx" target="_blank" rel="Template Excel File">
            ...
            <template #expanded-item="{ headers, item }">
              <td :colspan="headers.length" class="pa-5">
                ...
                <p class="mb-0">
                  Format
                  &nbsp;
                  <span v-if="item.format" class="font-weight-bold">
                    {{ trainingFormats[item.format] }}
                  </span>
                ...
                <p class="mb-0">
                  Instructor Name
                  &nbsp;
                  <span v-if="item.instructor_name" class="font-weight-bold">
                ...
                <p class="mb-0">
                  Start Date
                  &nbsp;
                  <span v-if="item.start_date" class="font-weight-bold">
                ...
                <p class="mb-0">
                  Date Detail
                  &nbsp;
                  <span v-if="item.detail_date" class="font-weight-bold">
                    {{ item.detail_date }}
                  </span>
                  <span v-else>Unknown data</span>
                </p>
                ...
                <p class="mb-0">
                  Place
                  &nbsp;
                  <span v-if="item.place" class="font-weight-bold">
                    {{ item.place }}
                  </span>
                  <span v-else>Unknown data</span>
                </p>
...
export default {
  ...
  async beforeMount () {
    ...
    this.$breadcrumbs.setItems([
      {
        text: this.modelName,
        to: { name: 'backend-manages-training-courses' }
      },
      {
        text: 'Upload'
      }
        ...
        for (const data of this.listDatas) {
          ...
          try {
            ...
            if (data.file && data.logo) {
              ...
              formData.append('training_img', data.file)
