        ...
        <v-card v-if="listDatas">
          <v-card-title class="pb-0">
            ...
            <v-btn
              ...
              depressed
              color="primary"
              @click="$bus.$emit('open-publication-form')"
            >
            ...
            <!-- <v-btn
              ...
              depressed
              color="info"
              :to="localePath({name: 'backend-manages-publications-uploads'})"
            >
              <v-icon small class="mr-1">
                fas fa-upload
              </v-icon>
          ...
          >
            ...
            <template #[`item.edit`]="{ item }">
              <v-icon
                small
                color="warning"
                @click="$bus.$emit('open-publication-form', item)"
              >
                fas fa-edit
              </v-icon>
            </template>
            ...
            <template #expanded-item="{ headers, item }">
              <td :colspan="headers.length">
                <div class="pt-3 px-3 pb-6">
                  ...
                  <label-value
                    label="Country"
                    :value="item.Journal.Publisher.Country.name"
                  />
                  ...
                  <label-value
                    label="Frequency Publish"
                    :value="item.frequency_publish"
                  />
                  ...
                  <div v-if="item.important">
                    <p class="subtitle-1 font-weight-bold mb-0">
                      Important Date
                    </p>
                    <div v-if="item.important" class="mb-3">
                      <div class="ck-content" v-html="item.important" />
                    </div>
                  </div>
                  <div v-if="item.topic">
                    <p class="subtitle-1 font-weight-bold mb-0">
                    ...
                    <div v-if="item.topic" class="mb-3">
                      <div class="ck-content" v-html="item.topic" />
                    </div>
                  </div>
                  <div v-if="item.budget_detail">
                    <p class="subtitle-1 font-weight-bold mb-0">
                      Registration Rate Detail
                    </p>
                    <div v-if="item.budget_detail" class="mb-3">
                      <div class="ck-content" v-html="item.budget_detail" />
                    </div>
                  </div>
                </div>
              </td>
...
export default {
  ...
  data () {
    return {
      api: `${process.env.apiUrl}${process.env.apiDirectory}publications`,
      ...
      tableHeaders: [
        ...
        {
          text: 'Country',
          value: 'Journal.Publisher.Country.name',
          sortable: false
        },
        {
          text: 'Edit',
