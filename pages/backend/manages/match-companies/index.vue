        ...
        <v-card v-if="listDatas">
          <v-card-title class="pb-0">
            ...
            <v-btn
              ...
              depressed
              color="primary"
              @click="$bus.$emit('open-match-company-form')"
            >
            ...
            <v-btn
              ...
              depressed
              color="info"
              :to="localePath({name: 'backend-manages-match-companies-uploads'})"
            >
              <v-icon small class="mr-1">
                fas fa-upload
              </v-icon>
          ...
          >
            ...
            <template #[`item.edit`]="{ item }">
              <v-icon
                small
                color="warning"
                @click="$bus.$emit('open-match-company-form', item)"
              >
                fas fa-edit
              </v-icon>
            </template>
...
export default {
  ...
  data () {
    return {
      api: `${process.env.apiUrl}${process.env.apiDirectory}match-companies`,
